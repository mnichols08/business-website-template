...
- Suggested structure for `public/`, `src/pages/`, `src/components/`, `src/styles/`, `src/content/`, and `src/lib/`
- SEO, accessibility, analytics, and contact-form guidance
...
### Added
- Initial template README with goals, structure, setup paths, and deployment options
- CHANGELOG initialized with Unreleased and first release sections
- Versioning guidance with example Git commands for tagging and pushing
